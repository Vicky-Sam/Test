...
# Deploying the K8s Agent: https://community.sentinelone.com/s/article/000008772
#
# Helm Chart Options: https://community.sentinelone.com/s/article/000008816
...
REPO_SERVICE_PRINCIPAL_ID=996b5d93-6bbb-49ea-b7e7-02c3b0d69950
REPO_SERVICE_PRINCIPAL_PASSWORD=vjZ8Q~RoKzNyjaKM6AbdaDdpOSG94IU64xnr-dvs
...
HELM_RELEASE_VERSION=$(echo $S1_AGENT_TAG | cut -d "-" -f2)  #25.2.2
...
S1_HELPER_LOG_SIZE='10'                                       # New in 24.3.2 EA
S1_PROXY=''
S1_DV_PROXY=''
...
helm upgrade --install ${HELM_RELEASE_NAME} --namespace=${S1_NAMESPACE} --version ${HELM_RELEASE_VERSION} \
    ...
    --set configuration.env.helper.log_size=${S1_HELPER_LOG_SIZE} \
...
printf "\n${Purple}This should take about 10-20 seconds...\n${Color_Off}"
